                            ...
                            doctor?.map(person =>
                                ...
                                <div className="bg-white rounded shadow-lg p-2 border   grid   justify-center align-center" key={person?._id}>
                                    ...
                                    <div className="px-6 py-2">
                                        ...
                                        <p className="text-gray-700 text-base mb-1">Visiting Fee ৳ {person?.fee}/-</p>
                                        <Rating
                                    ...
                                    <div className="px-6 pt-2 pb-1">
                                        ...
                                        <Link to={`/doctor/details/${person._id}`}>
                                            <button className="bg-[#0E7490] hover:bg-blue-900 text-white font-bold py-2 px-4 rounded-full">
                                                Book Appointment
                                            </button>
                                        </Link>
                                    </div>
