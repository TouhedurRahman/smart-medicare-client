...
const MedicineBrand = () => {
    ...
    return (
        <div className='container mx-auto' >
            {
                !location?.pathname.includes('/medicinebrand/brand')
                &&
                <h3
            ...
            }
            {
                location?.pathname.includes('/medicinebrand/brand')
                    ?
                    <MedicineCategory brand={brand} />
                    :
                    <MedicineCategory brand={brand.slice(0, 4)} />
            }
            <div className='flex items-center justify-end'  >
                {
                    location?.pathname === '/'
                    &&
                    <Link to="/medicinebrand/brand" className='text-center' >
